# -*- coding: utf-8 -*-
"""Premium Apple-style Next.js UI dosyalarini yazar."""
import urllib.request
from pathlib import Path

BASE = "https://raw.githubusercontent.com/ozgronurkoc/Twmq/main/frontend/app"
# Fallback: local copies embedded below if raw not yet available.
          ...
          <aside className="hidden sm:flex w-[240px] shrink-0 flex-col bg-[#0f0f10] text-white">
            ...
            <div className="mt-auto px-5 py-4 border-t border-white/5">
              <div className="text-[11px] text-zinc-600 leading-relaxed">
                Next.js UI · Python API<br /><span className="text-zinc-500">spor_toto · Fix-16</span>
              </div>
            </div>
          </aside>
...
Path('frontend/app').mkdir(parents=True, exist_ok=True)
Path('frontend/app/layout.tsx').write_text(LAYOUT, encoding='utf-8')
print('layout ok')
print('NOT: page.tsx/stats/health icin git pull veya install_premium_ui_full kullan')
print('DONE layout')
