...
backend/
  ...
  data/                st_history_2025_26.json · odds/ · iddaa/ · egitim/ ·
                       ...
                       sehir/ · xg/
  tests/               pytest (61 dosya → 1.856 test; §9'da katman dökümü)
  pyproject.toml
...
eşleme, ikinci kayıt). **61 test dosyası, parametrizasyonla
1.856 test.** Katman katman dökümü (dosyalar adıyla sayılıdır ki bu tablo
