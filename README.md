...
backend/
  ...
  data/                st_history_2025_26.json · odds/ · iddaa/ · egitim/ ·
                       fixtures/ · super_toto/
  tests/               pytest (38 dosya → 1.233 test; §9'da katman dökümü)
  pyproject.toml
...
yeniden kalibrasyon ve eğitim korpusu. **38 test dosyası, parametrizasyonla
1.233 test.** Katman katman dökümü (dosyalar adıyla sayılıdır ki bu tablo
...
| Tahmin katmanı | `predict` `evaluate` `recalibrate` `egitim` `cizgi` `bahisci` `disari` `kalibrasyon` `tahmin` `benzer` `elo` `dixon_coles` | 386 |
