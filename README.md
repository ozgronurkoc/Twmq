...
backend/
  ...
  tests/               pytest (72 dosya → 2.071 test; §9'da katman dökümü)
  pyproject.toml
...
2.071 test.** Katman katman dökümü (dosyalar adıyla sayılıdır ki bu tablo
...
| Haftanın hakkı (E6 · cephe · cetvel · Holm'lu işaret sınavı) | **`hafta_hakki`** | 22 |
