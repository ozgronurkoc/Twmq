...
backend/
  ...
  data/                st_history_2025_26.json · odds/ · iddaa/ · egitim/ ·
                       ...
                       sehir/ · xg/
  tests/               pytest (69 dosya → 2.035 test; §9'da katman dökümü)
  pyproject.toml
...
2.035 test.** Katman katman dökümü (dosyalar adıyla sayılıdır ki bu tablo
...
| Para karnesi (garanti tabanı · enflasyon · canlı · GERÇEK kolon dağılımı) | **`karne`** | 24 |
