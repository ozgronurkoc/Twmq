...
| **22 değişmezin hiçbiri ona bakmaz** | Sağlık katmanı vaadin canlıda geçerliliğini ölçer; bu dosya ürün vaadine girmiyor |
...
yerinde durur ve `/api/stats` ile 22 değişmez ona bakmaya devam eder. Yeni
...
Toplam 113 test bu dört veri setini korur (backend paketi 1.837 test). `python -m spor_toto.health`
