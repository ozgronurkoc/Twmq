...
| **3** | **S1'in kupon ayağı** | **Yeniden açıldı** (§10.3). Resmî arşiv haftaları veriyor ama maç listesi yalnızca bülten **görselinde**; yol OCR + bağımsız doğrulama |
...
### 10.3 Kupon ayağı — yeniden açıldı, kalan tek parça maç listesi
