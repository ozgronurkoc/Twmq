...
paketi toplam **629 test**; bunların **82'si** bu katmana ait. `python -m spor_toto.health`
**21 değişmez** çalıştırır — ikisi (`oran_arsivi`, `geri_test`) bu katmanı korur.
...
# Denetim
pytest -q                                  # 629 test (82'si bu katman)
