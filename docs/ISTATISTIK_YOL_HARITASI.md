...
paketi toplam **1.965 test**; **136'sı** istatistik katmanına (`history` `odds` `backtest`
...
tamsayıdır.
    ...
    kupon    kolon   model P(15)   gerçekleşen   13 hafta
        1   19.683       %7,489        15/114       %63,6   ← bugün
...
# Denetim
pytest -q                                  # 1.965 test (136'sı bu katman, 672'si tahmin)
