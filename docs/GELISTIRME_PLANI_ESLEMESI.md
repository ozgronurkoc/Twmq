...
> dosyası (1.856 test), ruff + kademeli mypy, on adımlı tek kalite kapısı ve
...
| 2 — test / regresyon | VAR | 61 dosya, 1.856 test; `scripts/check.sh` on adım (ruff · mypy · pytest · yavaş ILP · sağlık · CLI · boru hattı · üretilmiş dosya tazeliği · arayüz · üretim derlemesi) |
